...
public class KafkaConsumerService {
    ...
    public void listenTransferResponse(TaskMessage response) {
        taskService.listenTaskFromKafka(response);
        log.info("Получил сообщение из кафки listenTransferResponse  топик: " + responseTaskTopic + " объект: " + response);
    }

// этот код закоментить для запуска
